//
// read the keys on the left hand
//
#include "ArduinoProMicroMatrix.h"
#include <SoftwareSerial.h>

static int8_t row_pins[] = { A3, A2, A1, A0, 15, 16}; //Row5~Row0
static int8_t col_pins[] = { 8, 7, 6, 5, 4, 0, 1}; //Col0~Col6
...
matrix_row_t ArduinoProMicroMatrix::read_cols()
{
    ...
    for (uint8_t i = 0; i < SINGLE_HAND_MATRIX_COLS; i++) {
